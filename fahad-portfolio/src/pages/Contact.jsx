...
const EMAILJS_SERVICE_ID = 'service_ql5hti7';
const EMAILJS_TEMPLATE_ID = 'template_4paq9np';
const EMAILJS_PUBLIC_KEY = '9W74o4sm8-Yza0JsS';
...
const Contact = () => {
  ...
  const handleEmailSend = async (e) => {
    ...
    try {
      ...
      // Reset the status message back to idle after a few seconds
              ...
              <form className="contact__whatsapp-form">
                ...
                <div className="contact__submit-row">
                  ...
                  >
                    ...
                    <span>{status === 'sending' ? 'Sending...' : 'Send via Email'}</span>
                  </button>
                </div>
